...
class Post(models.Model):
    ...
    description = models.TextField("Comentario", max_length=500,blank=True)
    created_at = models.DateTimeField("Fecha de creacion", auto_now_add=True)
    likes = models.ManyToManyField(User, verbose_name="Nº de likes",related_name='liked_posts', blank=True)
